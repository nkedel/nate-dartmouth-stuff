...
.menu.buffers.menu delete 0 last
	...
	if {$statusArray($i) == "OPEN" } {
	    ...
	    .menu.window.menu add command -label "$fileName" -command "BringToTop $windowName"
	}
    }
...
# I want a go to line function, but I need a dialog box to do it
proc UI_GoToLine {} {
    global activeWindow WindowArray
