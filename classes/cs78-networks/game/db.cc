...
// database initialization routines called by master player to initialize
// the game on the server

// stub database used in development before network code was ready
//
